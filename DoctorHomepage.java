...
public class DoctorHomepage extends JFrame {
	...
	public void buildCenterPanel() {
		...
		// viewRecordButton.addActionListener(new ViewRecordButtonListener());
		logoutButton.addActionListener(new LogoutButtonListener());

		innerSouthPanel.setLayout(new FlowLayout(FlowLayout.CENTER, 25, 25));

		// innerSouthPanel.add(viewRecordButton);
	...
	/*
	 * private class ViewRecordButtonListener implements ActionListener {
	 * 
